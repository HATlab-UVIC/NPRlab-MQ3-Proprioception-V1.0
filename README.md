...
4. Connect your device to Windows computer using a link. If Sidequest says "Unauthorized", toggle developer mode on your Horizon mobile app while Meta Quest is connected to your PC. Allow "Allow debugging from this PC" option on your Meta Quest.
